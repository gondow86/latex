...
\begin{thebibliography}{99}
    \bibitem{pointcloud} Zhao, Peijun, et al. "Human tracking and identification through a millimeter wave radar." Ad Hoc Networks 116 (2021): 102475.
    \bibitem{tracklet} Yoneji, Matsubara, et al. "駅構内モニタカメラを用いた混雑度可視化技術" Information Processing Society of Japan, デジタルプラクティス 8 (2), pp.152-159, 2017
    \bibitem{dataset} S. Schellenberger, K.L. Shi, T. Steigleder, A. Malessa, F. Michler, L. Hameyer, N. Neumann, F. Lurz, R. Weigel, C. Ostgathe, A. Koelpin, A dataset of clinically recorded radar vital signs with synchronised reference sensor signals, Sci Data 7 (2020).
    \bibitem{fft-music} Kim, Sangdong, and Kyun-Kyung Lee. "Low-complexity joint extrapolation-MUSIC-based 2-D parameter estimator for vital FMCW radar." IEEE sensors journal 19.6 (2018): 2205-2216.
    ...
    \bibitem{respi} Kim, Sangdong, et al. "Human Identification by Measuring Respiration Patterns Using Vital FMCW Radar." Journal of Electromagnetic Engineering and Science 20.4 (2020): 302-306. 
    \bibitem{MD} Vandersmissen, Baptist, et al. "Indoor person identification using a low-power FMCW radar." IEEE Transactions on Geoscience and Remote Sensing 56.7 (2018): 3941-3952.
    \bibitem{motion} Senigagliesi, Linda, et al. "Classification of Human Activities based on Automotive Radar Spectral Images Using Machine Learning Techniques: A Case Study." 2022 IEEE Radar Conference (RadarConf22). IEEE, 2022.
\end{thebibliography}
\end{document}